...
<form class="woocommerce-ordering" method="get">
	...
	<?php if (zass_get_option('show_products_limit')) : ?>
		...
		<?php $products_per_page_from_options = intval(zass_get_option('products_per_page')); ?>
		...
		<?php if ($products_per_page_from_options > 0) : ?>
			...
			<div class="limit">
				...
				<select class="per_page" name="per_page" aria-label="Per Page">
					...
					$per_page_options['-1'] = esc_html__('Show All', 'zass');
