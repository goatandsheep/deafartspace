    ...
    this.init = function () {
      ...
      $mouseTrap.bind(m_ent, this, function (event) {
        ...
        zoomDiv = appendTo
          .append(
            format(
              '<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:0px;top:0px;width:%2px;height:%3px;background-image:url(\'%4\');z-index:99;"></div>',
              xPos,
              yPos,
              w,
              h,
    ...
    this.each(function () {
      ...
      if ($(this).is(".cloud-zoom")) {
        ...
        if ($(this).parent().attr("id") != "wrap") {
          $(this).wrap(
            '<div id="wrap" style="top:0px;z-index:auto;position:relative;"></div>'
          );
        }
    ...
    return this.each(function () {
      ...
      a(this).hover(
        function () {
          ...
          if (
            a(this).attr("title") ||
            typeof a(this).attr("original-title") != "string"
          ) {
            a(this)
              .attr("original-title", a(this).attr("title") || "")
              .removeAttr("title");
          }
          var f;
          ...
          var e = d[0].offsetWidth,
            h = d[0].offsetHeight;
          var g =
            typeof c.gravity == "function" ? c.gravity.call(this) : c.gravity;
          switch (g.charAt(0)) {
            case "n":
              d.css({
                top: i.top + i.height,
...
!(function (e) {
  (e.fn.appear = function (a, t) {
    var n = e.extend({ data: void 0, one: !0, accX: 0, accY: 0 }, t);
    return this.each(function () {
      var t = e(this);
      ...
      var r = e(window),
        o = function () {
          ...
          var e = r.scrollLeft(),
            ...
            u = t.width(),
            d = r.width();
          c + l + i >= a && a + s + i >= c && p + u + f >= e && e + d + f >= p
    ...
    (e.fn.countTo = function (a) {
      ...
      return e(this).each(function () {
        function r() {
          (c += n),
            p++,
            e(o).html(c.toFixed(a.decimals)),
            "function" == typeof a.onUpdate && a.onUpdate.call(o, c),
            p >= t &&
              (clearInterval(f),
              (c = a.to),
              "function" == typeof a.onComplete && a.onComplete.call(o, c));
        }
        var o = this,
          p = 0,
          c = a.from,
...
(Object.deepExtend = function (e, a) {
  ...
  (window.particlesJS = function (e, a) {
    ...
    if (null != document && null != e && null != n) {
    ...
    e(window).on("DOMContentLoaded load resize scroll", function () {
      ...
      i.find(".tps-section.tps-inview > .tps-wrapper").each(function (t) {
        var n = e(this),
          ...
          o =
            ((n.parent().offset().top - n.parent().height() - s) /
              e(window).height()) *
            r.angle *
            3,
          u =
            (s +
              e(window).height() -
              (n.parent().offset().top - n.parent().height())) /
            e(window).height();
        if (u > 1) u = 1;
        if (o < 0) o = 0;
        if (s > n.parent().offset().top) {
          if (r.outAnimation == false) {
            ...
            i =
              (n.parent().offset().top + e(window).height() * 1.2 - s) /
              e(window).height();
            i = Math.pow(i, 25);
            o =
              ((n.parent().offset().top - s) / e(window).height()) *
              r.angle *
              3;
            u =
              (s + e(window).height() - n.parent().offset().top) /
              e(window).height();
          }
        } else {
          if (t != 0) {
          ...
          if ("html" === d.contentType) {
            ...
            if ("<" === g || "&" === g) {
              ...
              for (
                ...
                ((h += a.substr(b).charAt(0)), b++, !(b + 1 > a.length));
