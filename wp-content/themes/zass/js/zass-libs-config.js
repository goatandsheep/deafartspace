(function ($) {
  ...
  $(document).ready(function () {
    ...
    if (typeof zass_isotope_infinite !== "undefined") {
      ...
      $("div.zass-portfolio-categories", "#main").each(function (
        i,
        buttonGroup
      ) {
    ...
    if (typeof zass_owl_carousel_cat !== "undefined") {
      ...
      $(".zass_woo_categories_shop.zass-owl-carousel", "#main").owlCarousel({
        ...
        responsive: {
          ...
          768: {
            items:
              zass_owl_carousel_cat.columns < 3
                ? zass_owl_carousel_cat.columns
                : "3",
          },
          1024: {
            items:
              zass_owl_carousel_cat.columns < 4
                ? zass_owl_carousel_cat.columns
                : "4",
          },
          1280: {
    ...
    if (typeof zass_quickview !== "undefined") {
      $("a.zass-quick-view-link", "#content").on("click", function (e) {
        ...
        $.post(zass_quickview.zass_ajax_url, data, function (response) {
          $.magnificPopup.open({
            mainClass: "zass-quick-view-lightbox mfp-fade",
            items: {
              src:
                '<div class="zass-quickview-product-pop">' +
                response +
                "</div>",
              type: "inline",
            },
    ...
    if (typeof zass_variation_prod_cloudzoom !== "undefined") {
      if (jQuery("#zoom1").length) {
        jQuery(document).on("update_variation_values", function () {
          ...
          jQuery("table.variations select option").on(
            "click",
            jQuery(this),
            function (event) {
  ...
  $.ZassAjaxSearch.prototype = {
    ...
    attempt_search: function (e) {
      ...
      if (
        ...
        this.timer = setTimeout(
          $.proxy(this.execute_search, this, e),
          this.options.delay
        );
      }
    },
    execute_search: function (e) {
      var obj = this,
        ...
        loading = $(
          '<div class="ajax_loading"><span class="ajax_loading_inner"></span></div>'
        ),
...
if (typeof zass_quickview !== "undefined") {
  (function ($, window, document, undefined) {
    $.fn.wc_variation_form = function () {
      $.fn.wc_variation_form.find_matching_variations = function (
        product_variations,
        settings
      ) {
        var matching = [];
        ...
        for (var i = 0; i < product_variations.length; i++) {
          ...
          if (
            $.fn.wc_variation_form.variations_match(
      ...
      $form = this
        ...
        .on("check_variations", function (event, exclude, focus) {
          ...
          var matching_variations =
            $.fn.wc_variation_form.find_matching_variations(
              all_variations,
              current_settings
            );
          ...
          if (all_set) {
            ...
            $variation_form.trigger("update_variation_values", [
              matching_variations,
            ]);
          ...
          $variation_form.find(".variations select").each(function (index, el) {
            ...
            if (!current_attr_select.data("attribute_options"))
              current_attr_select.data(
                "attribute_options",
                current_attr_select.find("option:gt(0)").get()
              );

            current_attr_select.find("option:gt(0)").remove();
            current_attr_select.append(
        ...
        .on("found_variation", function (event, variation) {
          ...
          var $single_variation_wrap = $variation_form.find(
    ...
    $(function () {
      ...
      $(
        ".zass-quickview-product-pop .variations_form .variations select"
      ).trigger("change");
    });
...
if (typeof zass_map_config !== "undefined") {
  ...
  var polylineOptionsActualCnt = new google.maps.Polyline({
    strokeColor: "#585858",
    strokeOpacity: 0.7,
    strokeWeight: 4,
  });

  function initializeCnt() {
    // Place the coordinates of your store here.
    var latlng = new google.maps.LatLng(
      zass_map_config.lattitude,
      zass_map_config.longitude
    );
    directionsDisplayCnt = new google.maps.DirectionsRenderer();
    directionsDisplayCnt = new google.maps.DirectionsRenderer({
      suppressMarkers: true,
      polylineOptions: polylineOptionsActualCnt,
    });
    ...
    var mapCnt = new google.maps.Map(
      document.getElementById("zass_map_canvas"),
      myOptionsCnt
    );
    ...
    var image = new google.maps.MarkerImage(
      zass_map_config.images + "marker.png",
    ...
    var shadow = new google.maps.MarkerImage(
      zass_map_config.images + "shadow.png",
    ...
    var marker = new google.maps.Marker({
      ...
      map: mapCnt,
      shadow: shadow,
      title: zass_map_config.location_title,
      icon: image,
    });
