...
* Synchronise product data to translations when updating via REST.
* Prevented an infinite recursion error with Stripe Gateway and Point of Sale addons.
* Fix Minimum WooCommerce version to 3.9 at Plugin's Header Comments.
